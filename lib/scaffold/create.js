...
var BASE_PACKAGE = {
  ...
  readme: 'README.md',
  dependencies: {
    'bitcore-lib-komodo': 'git+https://git@github.com/StakedChain/bitcore-lib-komodo',
    'bitcore-node-komodo': 'git+https://git@github.com/StakedChain/bitcore-node-komodo'
  }
};
